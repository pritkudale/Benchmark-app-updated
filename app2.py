...
benchmark_options = [
    ...
    {"label": "AIME 2025 (Competition Math)", "value": "AIME 2025"},
    {"label": "IFBench (Instruction Following)", "value": "IFBench"},
    {"label": "Terminal-Bench Hard (Agentic Coding & Terminal Use)", "value": "Terminal-Bench Hard"},
    {"label": "𝜏²-Bench Telecom (Agentic Tool Use)", "value": "𝜏²-Bench Telecom"},
    {"label": "AA-LCR (Long Context Reasoning)", "value": "AA-LCR"},
    {"label": "MMMU Pro (Visual Reasoning)", "value": "MMMU Pro (Visual Reasoning)"},
    {"label": "LegalBench (Legal Analysis)", "value": "LegalBench"},
    {"label": "MedQA (Medical)", "value": "MedQA"},
    {"label": "MGSM (Math)", "value": "MGSM"},
    {"label": "Chatbot Arena", "value": "Chatbot Arena"}
]
